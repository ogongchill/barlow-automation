...
def register_routes(app: AsyncApp, agent: IAgent) -> None:
    """모든 Slack 이벤트/커맨드 핸들러를 app에 등록한다."""
    mention_handler.register(app, agent)
    slash_handler.register(app, agent)
    message_handler.register(app, agent)
